...
export class DatabaseStorage implements IStorage {
  ...
  async getLead(id: number): Promise<Lead | null> {
    ...
    return {
      ...
      financingType: lead.leads.financingType,
      ownershipType: lead.leads.ownershipType,
      ownershipDetails: lead.leads.ownershipDetails,
      contractingType: lead.leads.contractingType,
      contractingDetails: lead.leads.contractingDetails,
  ...
  async getInvestors(userId: string, filters?: {
    ...
    try {
      ...
      if (userId) {
        conditions.push(eq(investors.userId, userId));
      }
